...
public enum ActxApiErrorCode implements ErrorCode {
    ...
    private static final Map<Integer, ActxApiErrorCode> idx = new HashMap();
    static {
        for (ActxApiErrorCode errorCode : ActxApiErrorCode.values())
            idx.put(errorCode.number, errorCode);
    }

    private final int number;

    private ActxApiErrorCode(int number) {
        this.number = number;
    }
    ...
    public static ActxApiErrorCode get(Integer number) {

...
public interface ActxChainApiService {

    @GET("/v1/chain/get_info")
    Call<ChainInfo> getChainInfo();

    // curl -X POST --url http://172.16.20.120:9000/v1/chain/get_block -d '{"block_num_or_id":"8"}'
    ...
    @POST("/v1/chain/get_account")
    Call<ActAccount> getActAccount(@Body Map<String, String> requestFields);

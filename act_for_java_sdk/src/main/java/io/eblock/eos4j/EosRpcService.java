...
public class EosRpcService {
    ...
    private final String ACT_SYMBOL = "act";
     ...
     *
     * @param pk              绉侀挜
     * @param contractAccount 鍚堢害璐︽埛
     * @param from            浠�
     * @param to              鍒�
     * @param quantity        甯佺閲戦
     * @param memo            鐣欒█
     * @return
     * @throws Exception
     */
    ...
    public Transaction createAccount(String pk, String creator, String newAccount, String owner, String active,
        ...
        TxAction createAction = new TxAction(creator, ACT_SYMBOL, "newaccount", createMap);
...
//        TxAction buyAction = new TxAction(creator, ACT_SYMBOL, "buyrambytes", buyMap);
...
//        buyAction.setData(ramData);
     ...
     * @param owner            鍏挜
     * @param active           鍏挜
     * @param buyRam           璐拱绌洪棿鏁伴噺
     * @param stakeNetQuantity 缃戠粶鎶垫娂
     * @param stakeCpuQuantity cpu鎶垫娂
     * @param transfer         鎶垫娂璧勪骇鏄惁杞�佺粰瀵规柟锛�0鑷繁鎵�鏈夛紝1瀵规柟鎵�鏈�
     * @return
     * @throws Exception
     */
    public Transaction createAccount(String pk, String creator, String newAccount, String owner, String active,
        ...
        TxAction delAction = new TxAction(creator, ACT_SYMBOL, "delegatebw", delMap);
    ...
    public Transaction voteproducer(String pk, String voter, String proxy, List<String> producers) throws Exception {
        ...
        // action
        TxAction action = new TxAction(voter, ACT_SYMBOL, "voteproducer", dataMap);
        actions.add(action);
        tx.setActions(actions);
        // sgin
        String sign = Ecc.signTransaction(pk, new TxSign(info.getChainId(), tx));
    ...
    private Tx getCommonTx(ChainInfo info) {
        Block block = getBlock(info.getLastIrreversibleBlockNum().toString());
        // tx
        Tx tx = new Tx();
